...
public:
  ...
  { };
  Span(int id,char* mp_start,size_t slot_size,size_t pool_size, Span* next,Span* prev):Span(id,new MemoryPool::MemoryPool{mp_start,pool_size,slot_size},next,prev){};
